...
$footer_top_column = esc_hml(get_theme_mod( 'apollo_footer_top_column', 'column-1' ));
$footer_bottom_column = esc_hml(get_theme_mod( 'apollo_footer_bottom_column', 'column-3' ));
?>
